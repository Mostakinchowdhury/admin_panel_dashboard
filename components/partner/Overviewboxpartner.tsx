...
const Overviewboxpartner = ({ className, classNameib, classNamei, amout, p, icon: Icon }: prop) => {
  return (
    <div className={`md:px-1.5 px-1 py-3 flex gap-1.5 ${className ? className : ''}`}>
      {/* icon */}
      <div
...
export default Overviewboxpartner
