...
export const Productpageprovider = ({ children }: { children: React.ReactNode }) => {
  ...
  return <productpagecontext.Provider value={values}>{children}</productpagecontext.Provider>
}
